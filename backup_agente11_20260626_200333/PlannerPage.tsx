  ...
  const handleCalculate = (input: DivePlanInput) => {
    ...
    try {
      const result = calculateDivePlan({
        ...
        bottomGas: { fO2: input.fO2 / 100, fHe: 0 },
        decoGases: [],
      ...
      // Calcular plan contingencia (No 50%)
        ...
        {plan && (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="bg-ocean-dark border border-ocean-surface/20 rounded-2xl p-4 text-center">
                <div className="text-2xl font-bold text-alert-red">{'N/A'}%</div>
                <div className="text-text-secondary text-xs">CNS</div>
              </div>
              <div className="bg-ocean-dark border border-ocean-surface/20 rounded-2xl p-4 text-center">
                <div className="text-2xl font-bold text-success-green">{'N/A'}</div>
            ...
            <div className="flex gap-2 mb-4">
              <button className="flex-1 bg-padi-blue/20 text-padi-blue border border-padi-blue/30 rounded-lg py-2 text-sm font-medium">
                Plan Normal
              </button>
              <button className="flex-1 bg-alert-red/20 text-alert-red border border-alert-red/30 rounded-lg py-2 text-sm font-medium">
                Plan Contingencia (No 50%)
              </button>
            </div>
            ...
            {contingencyPlan && (
              <div className="mt-6 pt-6 border-t border-ocean-surface/20">
                <h3 className="text-alert-red font-bold mb-4 flex items-center gap-2">
                  ...
                  Plan Contingencia (Sin Deco Gases - No 50%)
                </h3>
                <DecoTable
